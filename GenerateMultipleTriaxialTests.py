...
Porosity_list = ['0.25', '0.30', '0.35', '0.40']
...
with open(cases_run_path_and_name, "w") as f_w_cases_run:
    ...
    for Porosity in Porosity_list:
        ...
        for confining_stress in confining_stress_list:
            ...
            #creat new folder
            new_folder_name = 'Triaxial_Po' + Porosity + '_P' + str(confining_stress)
            ...
            for seed_file_name in seed_file_name_list:
                ...
                if seed_file_name == 'MaterialsDEM.json':
                    ...
                    special_file_name = 'G-Triaxial-p-' + Porosity + '.mdpa'
                    special_file_path_and_name = os.path.join(os.getcwd(),'G-Triaxial-VaryP',special_file_name)
